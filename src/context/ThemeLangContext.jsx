...
export const translations = {
  zh: {
    ...
    activeRooms: '進行中的課堂活動',
    noActivitiesFound: '此章節尚無互動題型',

    // Teacher Session
    lobbyTitle: '等待學生加入活動',
    roomCode: '活動代碼',
    scanToJoin: '手機掃描 QR Code 或輸入活動代碼加入',
  ...
  en: {
    ...
    activeRooms: 'Active Activities',
    noActivitiesFound: 'No activities in this chapter',

    // Teacher Session
    lobbyTitle: 'Waiting for Students',
    roomCode: 'Activity Code',
    scanToJoin: 'Scan QR Code or enter Activity Code to join',
    ...
    roomClosed: 'Activity has ended or not yet started',
